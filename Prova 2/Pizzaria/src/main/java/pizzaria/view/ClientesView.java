...
public class ClientesView extends javax.swing.JFrame {
    ...
    private DefaultTableModel atualizarTabela(){
        ...
        List<Clientes> listaClientes = clientesController.listarTodos();
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        if(linhaSelecionada != -1){
            ...
            int resultado = JOptionPane.showConfirmDialog(null, "Deseja realmente EXCLUIR o cliente " + nomeCliente + "?", "Excluir?", 0);
            if(resultado == 0){
                new ClientesController().remover(idCliente);
                tblClientes.setModel(atualizarTabela());
            }
        }
        else{
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        // TODO add your handling code here:
        new CadastrarClienteView(this, true).setVisible(true);
        tblClientes.setModel(atualizarTabela());
