...
public class PedidosView extends javax.swing.JFrame {
    ...
    public PedidosView() {
        initComponents();
        tblPedidos.setModel(atualizarTabela());
    }

    private DefaultTableModel modeloTabela;
    private DefaultTableModel atualizarTabela(){
        PedidosController PedidosController = new PedidosController();
        List<Pedido> listaPedidos = PedidosController.listarTodos();
        
        String[] colunas = {"ID", "Nome do Cliente", "Nome do Usuario"};
        ...
        try {
            ...
            Object[] linha = {
                pedido.getId(),
                pedido.getClientes().getNome(),
                pedido.getUsuarios().getNome()
            };
    ...
    private void initComponents() {
        ...
        if (tblPedidos.getColumnModel().getColumnCount() > 0) {
            ...
            tblPedidos.getColumnModel().getColumn(0).setPreferredWidth(10);
        }
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if(linhaSelecionada != -1){
            ...
            EditarPedidosView telaEdicao = new EditarPedidosView(this, true, idPedido);
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        if(linhaSelecionada != -1){
            int idPedido = (int) modeloTabela.getValueAt(linhaSelecionada, 0);
            String nomeCliente = modeloTabela.getValueAt(linhaSelecionada, 1).toString();
            int resultado = JOptionPane.showConfirmDialog(null, "Deseja realmente EXCLUIR o pedido do cliente " + nomeCliente + "?", "Excluir?", 0);
            if(resultado == 0){
                new PedidosController().remover(idPedido);
                tblPedidos.setModel(atualizarTabela());
            }
        }
        else{
