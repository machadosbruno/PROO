...
public class PizzaView extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(PizzaView.class.getName());
    ...
    public PizzaView() {
        initComponents();
        tblPizza.setModel(atualizarTabela());
    }

    private DefaultTableModel modeloTabela;
    private DefaultTableModel atualizarTabela(){
        PizzaController pizzasController = new PizzaController();
        List<Pizza> listaPizzas = pizzasController.listarTodos();
    ...
    private void initComponents() {
        ...
        lblPizza.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        // TODO add your handling code here:
        int linhaSelecionada = tblPizza.getSelectedRow();
        if(linhaSelecionada != -1){
            int idPizza = (int) modeloTabela.getValueAt(linhaSelecionada, 0);
            
            EditarPizzaView telaEdicao = new EditarPizzaView(this, true, idPizza);
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        if(linhaSelecionada != -1){
            int idPizza = (int) modeloTabela.getValueAt(linhaSelecionada, 0);
            String nomePizza = modeloTabela.getValueAt(linhaSelecionada, 1).toString();
            int resultado = JOptionPane.showConfirmDialog(null, "Deseja realmente EXCLUIR a pizza " + nomePizza + "?", "Excluir?", 0);
            if(resultado == 0){
                new PizzaController().remover(idPizza);
                tblPizza.setModel(atualizarTabela());
            }
        }
        else{
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        // TODO add your handling code here:
        new CadastrarPizzaView(this, true).setVisible(true);
        tblPizza.setModel(atualizarTabela());
    ...
    private void btnVerIngredientesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerIngredientesActionPerformed
        // TODO add your handling code here:
        new PizzaIngredientesView().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new PizzaView().setVisible(true));
    }
